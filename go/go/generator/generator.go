...
func GeneratorVariadicFunc(f func(yield Yield, args ...any)) func(args ...any) *Generator {
	...
	return func(args ...any) *Generator {
		go supplierF(args...)
		return g
	}
}
...
func sendChan(ctx context.Context, c any, msg any) {
...
// arg -> func
func goFunc(ctx context.Context, f any, msg any) {
	go f.(func(any))(msg)
}
