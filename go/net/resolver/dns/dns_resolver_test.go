...
func testDNSResolver(t *testing.T) {
	...
	for _, a := range tests {
		...
		r, err := b.Build(resolver.Target{Endpoint: a.target}, cc)
		if err != nil {
			t.Fatalf("%v\n", err)
		}
...
func TestDNSResolverExponentialBackoff(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			r, err := b.Build(resolver.Target{Endpoint: test.target}, cc)
			if err != nil {
...
func testIPResolver(t *testing.T) {
	...
	for _, v := range tests {
		...
		r, err := b.Build(resolver.Target{Endpoint: v.target}, cc)
		if err != nil {
			t.Fatalf("%v\n", err)
		}
		var state resolver.State
...
func TestResolveFunc(t *testing.T) {
	...
	for _, v := range tests {
		...
		r, err := b.Build(resolver.Target{Endpoint: v.addr}, cc)
		if err == nil {
			r.Close()
		}
...
func TestDNSResolverRetry(t *testing.T) {
	...
	r, err := b.Build(resolver.Target{Endpoint: target}, cc)
	if err != nil {
		t.Fatalf("%v\n", err)
	}
	defer r.Close()
...
func TestCustomAuthority(t *testing.T) {
	...
	for _, a := range tests {
		...
		r, err := b.Build(resolver.Target{Endpoint: "foo.bar.com", Authority: a.authority}, cc)
