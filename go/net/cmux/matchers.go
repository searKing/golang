...
func HTTP1HeaderField(name, value string) MatcherFunc {
	return func(w io.Writer, r io.Reader) bool {
...
func HTTP1HeaderFieldPrefix(name, valuePrefix string) MatcherFunc {
	return func(w io.Writer, r io.Reader) bool {
		return matchHTTP1Field(r, name, func(gotValue string) bool {
...
// headers frame.
func HTTP2HeaderField(name, value string) MatcherFunc {
	return func(w io.Writer, r io.Reader) bool {
...
func HTTP2HeaderFieldPrefix(name, valuePrefix string) MatcherFunc {
	return func(w io.Writer, r io.Reader) bool {
		return matchHTTP2Field(ioutil.Discard, r, name, func(gotValue string) bool {
			return strings.HasPrefix(gotValue, valuePrefix)
		})
...
func HTTP2MatchHeaderFieldSendSettings(name, value string) MatcherFunc {
	return func(w io.Writer, r io.Reader) bool {
...
func HTTP2MatchHeaderFieldPrefixSendSettings(name, valuePrefix string) MatcherFunc {
	return func(w io.Writer, r io.Reader) bool {
		return matchHTTP2Field(w, r, name, func(gotValue string) bool {
			return strings.HasPrefix(gotValue, valuePrefix)
		})
...
func hasHTTP2Preface(w io.Writer, r io.Reader) bool {
