...
const (
	...
	// CharsetBase64StdEncoding is the standard base64 encoding, as defined in
	// RFC 4648.
	CharsetBase64StdEncoding = CharsetBase64RawStdEncoding + string(base64.StdPadding)

	// CharsetBase64URLEncoding is the alternate base64 encoding defined in RFC 4648.
	// It is typically used in URLs and file names.
	CharsetBase64URLEncoding = CharsetBase64RawURLEncoding + string(base64.StdPadding)

	// CharsetBase64RawStdEncoding is the standard raw, unpadded base64 encoding,
	// as defined in RFC 4648 section 3.2.
	// This is the same as StdEncoding but omits padding characters.
	CharsetBase64RawStdEncoding = CharsetAlphaNum + "+/"

	// CharsetBase64RawURLEncoding is the unpadded alternate base64 encoding defined in RFC 4648.
	// It is typically used in URLs and file names.
	// This is the same as URLEncoding but omits padding characters.
	CharsetBase64RawURLEncoding = CharsetAlphaNum + "-_"
)

// StringWithCharset takes in a character set and a length and will generate a random string using that character set.
...
// String only takes in a length, and will use a default characters set to generate a random string
