...
func Usage() {
	...
	_, _ = fmt.Fprintf(os.Stderr, "\thttps://pkg.go.dev/github.com/searKing/golang/tools/go-validator\n")
...
func main() {
	...
	g.Printf("\n")
	g.Printf("// Install %[1]s by `go get install github.com/searKing/golang/tools/%[1]s`", goValidatorToolName)
	g.Printf("\n")
